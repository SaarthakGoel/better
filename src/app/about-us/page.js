...
export default function Aboutus() {
  ...
  return (
    <div className="bg-[#f6f6f3] relative">
      ...
      {
        popUp ? <div className={`fixed z-20 top-[20%] left-[20%]`}><ReactPlayer url={`https://www.youtube.com/watch?v=1KjYlLBM9j4`} controls playing={true} width={1000} height={500} /></div> : null
      }


      <Header />

      <div className="h-[95vh] px-80 flex flex-col gap-8 justify-center items-center">
        <h3 className="text-3xl text-[#017848]">Our mission</h3>
        <h1 className="text-[2.4rem] font-medium text-center">
          We’re making homeownership simpler, faster — and most importantly, more accessible for all Americans.
        </h1>
      </div>

      <div className="flex gap-20 justify-center items-center h-[60vh] px-60">
      ...
      <div className="bg-[#017848]">
        <div className="px-80 py-20 text-white">
