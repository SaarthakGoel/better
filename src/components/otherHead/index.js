...
export default function Header2() {
  ...
  const content = (
<div className="flex justify-between items-center bg-[#eefaf5] px-24 py-6 fixed top-0 left-0 right-0 z-[1000]">
        ...
        <ul className="flex justify-center items-center gap-6">
          ...
          <li className="rounded-full py-3 px-5 transition-all duration-300 text-gray-500 hover:bg-[#d9e2dc]"><Link href='/'>Sign in</Link></li>
          <li className="text-white bg-[#017848] rounded-full py-3 px-5 transition-all duration-300 hover:bg-[#004733] hover:text-white"><Link href='/'>Continue</Link></li>
