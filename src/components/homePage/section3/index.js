...
export default function Section3() {
  ...
  const Section3Card1 = ({heading, img}) => {
    return (
      <div className="w-[400px] flex flex-col bg-[#f0f7f1] rounded-lg p-10 gap-6">
        <div className="flex flex-col gap-6">
          <h1 className="text-2xl">{heading}</h1>
          <button onClick={() => router.push('/mortgage-calculator')}><svg width="48" height="49" viewBox="0 0 48 49" fill="none" class="transition ease-universal duration-300 fill-transparent hover:fill-white [&amp;_path]:fill-[#004733] group-hover:[&amp;_path]:fill-white [&amp;_rect]:stroke-[#A4A8A4] group-hover:[&amp;_rect]:stroke-none" xmlns="http://www.w3.org/2000/svg"><rect x="0.5" y="0.843384" width="47" height="47" rx="23.5" stroke="#A4A8A4"></rect><path d="M24 16.3434L22.59 17.7534L28.17 23.3434H16V25.3434H28.17L22.59 30.9334L24 32.3434L32 24.3434L24 16.3434Z" fill="#004733"></path></svg></button>
        </div>
        <div>
          <Image className="rounded-lg" src={img} height={300} width={400} alt="cardimg" />
        </div>
      </div>
    )
  }
  ...
  const Section3Card2 = ({heading, img, description}) => {
    return (
      <div className="w-[400px] lg:w-[700px] flex flex-col lg:flex-row bg-[#f0f7f1] rounded-lg p-10 gap-6">
  ...
  const Section3Card3 = ({heading, img, description}) => {
    return (
      <div className="w-[400px] lg:w-[700px] flex flex-col lg:flex-row-reverse bg-[#f0f7f1] rounded-lg p-10 gap-6">
        <div className="flex-[0.6] flex flex-col gap-6">
          <h1 className="text-2xl">{heading}</h1>
          <p className="text-sm hidden lg:block">{description}</p>
          <button onClick={() => router.push('/mortgage-calculator')}><svg width="48" height="49" viewBox="0 0 48 49" fill="none" className="transition ease-universal duration-300 fill-transparent hover:fill-white [&amp;_path]:fill-[#004733] group-hover:[&amp;_path]:fill-white [&amp;_rect]:stroke-[#A4A8A4] group-hover:[&amp;_rect]:stroke-none" xmlns="http://www.w3.org/2000/svg"><rect x="0.5" y="0.843384" width="47" height="47" rx="23.5" stroke="#A4A8A4"></rect><path d="M24 16.3434L22.59 17.7534L28.17 23.3434H16V25.3434H28.17L22.59 30.9334L24 32.3434L32 24.3434L24 16.3434Z" fill="#004733"></path></svg></button>
        </div>
        <div className="flex-[0.4]">
          <Image className="rounded-lg" src={img} height={300} width={300} alt="cardimg" />
        </div>
